...
class main_ui:
    ...
    def __init__(
        ...
        try:
            ...
            self.assets = os.path.join(
                Path(__file__).parent.parent.parent, r"assets\img"
            )
            ...
            self.delete_holder = callbackDeleteHolder
    ...
    def initialize_cb(self):
        try:
            ...
            self.reportLength_btn = self.theDialog.TopBlock.FindBlock(
                "reportLength_btn"
            )
            self.reportCSETime_btn = self.theDialog.TopBlock.FindBlock(
                "reportCSETime_btn"
            )
            self.del_toolholder_btn = self.theDialog.TopBlock.FindBlock(
                "del_toolholder_btn"
            )
            # Label
            ...
            # BalloTooltipImage
            self.reportLength_btn.BalloonTooltipImage = os.path.join(
                self.assets, "ReportLength.bmp"
            )
    ...
    def update_cb(self, block):
        try:
            if block == self.numberTools_btn:
                ...
                self.reportCSETime()
                pass
            elif block == self.del_toolholder_btn:
                self.delete_holder()
                # ---- Enter your code here -----
                pass
        except Exception as ex:
