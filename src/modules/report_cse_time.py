...
class ReportCSETime:
    ...
    def report_time(self):
        ...
        for i, operationTime in enumerate(self.operationTimes):
            ...
            lw(
                f"       Material Cutting Time   : { operationTime['cseMaterialCuttingTime']}"
            )
            lw(
                f"       Air Cutting Time        : { operationTime['cseAirCuttingTime']}"
            )
            lw(
                f"       Positioning Mixed Time  : { operationTime['csePositioningMixedTime']}"
            )
            ...
            lw(
                f"       ToolChange Time         : { operationTime['cseToolChangeTime']}"
            )
            lw(
                f"       Positioning Linear Time : { operationTime['csePositioningLinearTime']}"
            )
            lw(
                f"       Positioning Rotary Time : { operationTime['csePositioningRotaryTime']}"
            )
            lw("***************************************************")
        return
